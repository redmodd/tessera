...
- **Releases run on changesets.** User-facing changes to either published package need a `pnpm changeset`; internal-only changes (docs, CI, no-API-impact refactors) don't. See [CONTRIBUTING.md](./CONTRIBUTING.md).
