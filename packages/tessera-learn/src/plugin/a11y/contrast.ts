 ...
 * browser-only; this runs at build time in the linter (rule 1.7). Only #hex
 * (3/4/6/8) is parsed — other CSS color forms return null and fall through to
 * the Tier-2 axe audit, which uses the browser's own parser.
 */
...
/** sRGB hex → relative luminance (0–1), or null if not a parseable hex. */
