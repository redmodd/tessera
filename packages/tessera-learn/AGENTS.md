...
| `feedbackMode`  | `"review" \| "immediate" \| "never"` | `"review"` | `immediate`: the button reads "Submit Answer" and each answer is locked and reported as the learner submits it. `review`: post-submit only. `never`: off |
