...
- d718691: Percentage completion no longer counts a quiz page until its quiz is submitted.
...
- 54f1b21: Send an xAPI `scored` statement when the score changes without a Passed/Failed to carry it.
